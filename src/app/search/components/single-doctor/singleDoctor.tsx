                ...
                <div className={styles.descWrapper}>
                  ...
                  <div className={styles.comment}>
                    <svg
                      ...
                      height="1em"
                      className="plasmic-default__svg plasmic_all__wY2Hq PlasmicProductCard_svg___4KelP__E0thA"
                      role="img"
                    >
                      <path
