  ...
  return (
    <Card>
      ...
      <div className={styles.about}>
        ...
        هستم. هدف من ارائه خدمات درمانی باکیفیت و کمک به بیماران برای دستیابی به
        سلامتی و بهبود کیفیت زندگی آن‌ها است. با بیش از {doctor.experience} سال
        ...
        به مراجعین خود ارائه دهم. من به اهمیت ارتباط مؤثر با بیماران معتقدم و
        تمام تلاش خود را می‌کنم تا شرایط پزشکی و راه‌حل‌های درمانی را به زبان
        ساده و قابل درک توضیح دهم. اگر به دنبال تشخیص دقیق و درمان مؤثر هستید،
